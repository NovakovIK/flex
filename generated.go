...
func (ec *executionContext) _Media_id(ctx context.Context, field graphql.CollectedField, obj *Media) graphql.Marshaler {
...
func (ec *executionContext) _Media_name(ctx context.Context, field graphql.CollectedField, obj *Media) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object:   "Media",
...
func (ec *executionContext) _Media_status(ctx context.Context, field graphql.CollectedField, obj *Media) graphql.Marshaler {
	ctx = ec.Tracer.StartFieldExecution(ctx, field)
	defer func() { ec.Tracer.EndFieldExecution(ctx) }()
	rctx := &graphql.ResolverContext{
		Object:   "Media",
...
func (ec *executionContext) unmarshalInputMediaInput(ctx context.Context, v interface{}) (MediaInput, error) {
	...
	for k, v := range asMap {
		...
		case "time_point":
			var err error
			it.TimePoint, err = ec.unmarshalNInt2int(ctx, v)
			if err != nil {
				return it, err
			}
		case "last_seen":
...
func (ec *executionContext) marshalNMedia2githubᚗcomᚋNovakovIKᚋflexᚐMedia(ctx context.Context, sel ast.SelectionSet, v Media) graphql.Marshaler {
	return ec._Media(ctx, sel, &v)
}

func (ec *executionContext) marshalNMedia2ᚖgithubᚗcomᚋNovakovIKᚋflexᚐMedia(ctx context.Context, sel ast.SelectionSet, v *Media) graphql.Marshaler {
	if v == nil {
		if !ec.HasError(graphql.GetResolverContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOMedia2ᚕᚖgithubᚗcomᚋNovakovIKᚋflexᚐMedia(ctx context.Context, sel ast.SelectionSet, v []*Media) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
